...
const Welcome_screen4 = ({ navigation }) => {
  const image2 = require('../assets/images/Homescreen4-1.png');
  const backgroundImage = require('../assets/images/Homescreen2-1.png');
  const image3 = require('../assets/images/Homescreen4-2.png');
      ...
      <View style={{ position: 'absolute', top: 100, left: 0, right: 0, bottom: 0 }}>
        <View style={{ flex: 2, justifyContent: 'center', alignItems: 'center' }}>
          ...
          <View style={{ justifyContent: 'center', alignItems: 'center' }}>
           ...
           <Text style={{ color: '#529C4F' }}>حولها</Text> و إستعملها !
          </Text>
          </View>
        </View>
...
export default Welcome_screen4;
